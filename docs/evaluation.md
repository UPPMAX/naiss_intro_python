...
Goal                                         |Form
---------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------
Share any feedback anonymously during the day|[Feedback form](https://github.com/UPPMAX/naiss_intro_python/issues/27)
Evaluate the course anonymously              |[Course evaluation form](https://github.com/UPPMAX/naiss_intro_python/issues/27)
